...
{
    public class JoystickMainLayout : LinearLayout, Android.Views.View.IOnTouchListener
    {
        ...
        private void SetContent(Context context)
        {
            ...
            inflater.Inflate(TelloDrone.Resource.Layout.joystickMainLayout, this);
            ...
            _myJoyStick = FindViewById<LinearLayout>(TelloDrone.Resource.Id.text_input_start_icon);
        ...
        public bool OnTouch(Android.Views.View v, MotionEvent e)
        {
            switch (e.Action)
            {
                ...
                case MotionEventActions.Move:
                    ...
                    var parent = v.Parent as Android.Views.View;
